...
const upcomingEvents = [
  {
    ...
    description: 'Join us for a campus photowalk to capture the winter golden hour. All cameras (including phones) are welcome!'
  },
  {
    title: 'Lightroom Editing Workshop',
    date: 'Dec 07, 2025',
    time: '2:00 PM - 4:00 PM',
    description: 'Learn the basics of photo editing in Adobe Lightroom. We will cover color grading, masking, and presets. (Room C-204)'
  },
  {
    title: 'Short Film Contest Kick-off',
    date: 'Dec 14, 2025',
    time: '4:00 PM - 5:00 PM',
    description: 'Announcing our 48-hour short film challenge! Come to the kick-off event to get the theme and rules. Prizes to be won.'
  }
];
// --- END MOCK DATA ---

export default function ReflectionClub() {
  const pageStyle = {
        ...
        <div className="bg-black bg-opacity-40 p-8 rounded-2xl shadow-xl backdrop-blur-lg border border-white border-opacity-20 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
            ...
            <div className="text-center md:text-left mt-4">
              <h1 className="text-6xl font-extrabold text-gray-400 mb-3">
                Reflection
              </h1>
