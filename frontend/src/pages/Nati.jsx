...
const upcomingEvents = [
  {
    title: 'Rangrezz \'24: Annual Theatre Fest',
    date: 'Nov 30, 2025',
    time: '4:00 PM - 7:00 PM',
    description: 'Our flagship event! A full evening of stage plays, nukkad natak, and dramatic monologues. Join us at the main auditorium.'
  },
  {
    title: 'Improv Workshop',
    date: 'Dec 05, 2025',
    time: '2:00 PM - 4:00 PM',
    description: 'Learn the basics of improvisational acting. No script, no fear! A fun session for all skill levels in the C-Block atrium.'
  },
  {
    title: 'Auditions: The Spring Play',
    date: 'Dec 10, 2025',
...
export default function Nati() {
  const pageStyle = {
    backgroundImage: "url('/creative.png')",
        ...
        <div className="bg-black bg-opacity-40 p-8 rounded-2xl shadow-xl backdrop-blur-lg border border-white border-opacity-20 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
            ...
            <div className="text-center md:text-left mt-4">
              ...
              <p className="text-2xl text-gray-200 mb-4">
                The Dramatics Club: Bringing Stories to Life
              </p>
          ...
          <div className="mt-12 border-t border-gray-600 pt-8">
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              Nati, the dramatics club, showcases stage plays, skits, and street theatre performances. We bring stories to life and provide a platform for actors, writers, and directors to explore their passion and hone their craft.
            </p>
          </div>
        </div>
      </main>
