...
const upcomingEvents = [
  {
    ...
    description: 'Learn the essentials of version control. We will cover everything from `git init` to making your first Pull Request.'
  },
  {
    title: 'Hacktoberfest Prep Session',
    date: 'Dec 14, 2025',
    time: '3:00 PM - 5:00 PM',
    description: 'Hacktoberfest is coming! Learn how to find good-first-issues and make meaningful contributions to open source projects.'
  },
  {
    title: 'Project Showcase: FOSS@Chitkara',
    date: 'Dec 21, 2025',
    time: '4:00 PM - 5:00 PM',
    description: 'See the amazing open-source projects being built right here on campus. Get inspired and find a project to join!'
  }
];
// --- END MOCK DATA ---
