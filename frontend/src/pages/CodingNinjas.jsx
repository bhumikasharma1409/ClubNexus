...
const upcomingEvents = [
  {
    title: 'CodeSprint: DSA Challenge',
    date: 'Nov 28, 2025',
    time: '10:00 AM - 1:00 PM',
    description: 'A 3-hour competitive programming contest. Solve 5 problems of increasing difficulty. Prizes for the top 3 coders!'
  },
  {
    title: 'Intro to Web Dev Workshop',
    date: 'Dec 02, 2025',
    time: '3:00 PM - 5:00 PM',
    description: 'Learn the basics of HTML, CSS, and JavaScript. We will build and deploy a simple portfolio website from scratch. (Room C-201)'
  },
  {
    title: 'Tech Talk: Life at Google',
    date: 'Dec 07, 2025',
