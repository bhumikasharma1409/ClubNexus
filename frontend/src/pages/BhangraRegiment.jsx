...
const upcomingEvents = [
  {
    title: 'Bhangra Night 2025',
    date: 'Nov 25, 2025',
    time: '6:00 PM - 8:00 PM',
    description: 'Our biggest event of the year! An evening full of high-energy performances, dhol beats, and celebrating Punjabi culture.'
  },
  {
    title: 'Beginner Bhangra Workshop',
    date: 'Dec 01, 2025',
    time: '2:00 PM - 4:00 PM',
    description: 'Always wanted to learn Bhangra? Join our free workshop for beginners. No prior dance experience needed!'
  },
  {
    title: 'Flash Mob at Exploria',
    date: 'Dec 05, 2025',
    time: '1:00 PM Sharp',
        ...
        <div className="bg-black bg-opacity-40 p-8 rounded-2xl shadow-xl backdrop-blur-lg border border-white border-opacity-20 max-w-4xl mx-auto">
          ...
          <div className="mt-12 border-t border-gray-600 pt-8">
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              A high-energy bhangra crew spreading Punjabi culture through dance and enthusiasm. We perform at university events and national competitions, bringing the vibrant spirit of Punjab to every stage.
            </p>
          </div>
        </div>
      </main>
