...
const upcomingEvents = [
  {
    title: 'Giddha Night: Folk Celebration',
    date: 'Nov 27, 2025',
    time: '5:00 PM - 7:00 PM',
    description: 'An evening dedicated to the grace and energy of traditional Giddha. Join us for performances and open-floor dancing.'
  },
  {
    title: 'Giddha Workshop for Beginners',
    date: 'Dec 04, 2025',
    time: '2:00 PM - 4:00 PM',
    description: 'Learn the basic steps, claps (taali), and "boliyan" of Giddha. Open to all female students, no experience required.'
  },
  {
        ...
        <div className="bg-black bg-opacity-40 p-8 rounded-2xl shadow-xl backdrop-blur-lg border border-white border-opacity-20 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
            ...
            <div className="text-center md:text-left mt-4">
              <h1 className="text-6xl font-extrabold text-pink-500 mb-3">
                Lethal Giddha Squad
              </h1>
