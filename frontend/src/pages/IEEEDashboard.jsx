    ...
    useEffect(() => {
        const initializeDashboard = async () => {
            ...
            try {
                ...
                if (ieeeClub) {
                    console.log("Found Club ID:", ieeeClub._id);
                    setClubId(ieeeClub._id); // Store clubId in state
        ...
        <div className="min-h-screen bg-gray-100 flex">
            ...
            <aside className="w-64 bg-black shadow-md flex flex-col fixed h-full border-r border-gray-800">
                <div className="p-6 border-b border-gray-800">
                    ...
                    <div className="flex items-center gap-2 pl-1">
                        <img src="/ieee.webp" alt="IEEE Logo" className="w-6 h-6 rounded-full object-cover border border-gray-600" />
                        <p className="text-sm text-gray-400 font-medium">IEEE Admin</p>
                    </div>
                </div>
            ...
            <main className="flex-1 p-8 ml-64">
                <header className="flex justify-between items-center mb-8">
                    <div>
                        <h2 className="text-3xl font-bold text-gray-800">IEEE Club</h2>
