...
const upcomingEvents = [
  {
    title: 'Ghungroo Workshop: Kathak Basics',
    date: 'Dec 01, 2025',
    time: '4:00 PM - 6:00 PM',
    description: 'An introductory workshop on the basics of Kathak, including footwork, hand gestures (mudras), and spins (chakkars).'
  },
  {
    title: 'Classical Forms Showcase',
    date: 'Dec 08, 2025',
    time: '5:00 PM - 7:00 PM',
    description: 'An evening celebrating diverse classical forms. See performances of Bharatanatyam, Kathak, and Odissi by our talented members.'
  },
  {
    title: 'Spring Showcase Auditions',
    date: 'Dec 15, 2025',
    time: '3:00 PM onwards',
    description: 'We are holding auditions for our grand spring production. Dancers from all classical disciplines are welcome to try out.'
  }
];
// --- END MOCK DATA ---
        ...
        <div className="bg-black bg-opacity-40 p-8 rounded-2xl shadow-xl backdrop-blur-lg border border-white border-opacity-20 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
            ...
            <div className="text-center md:text-left mt-4">
              <h1 className="text-6xl font-extrabold text-red-700 mb-3">
                Natraj
              </h1>
