...
const upcomingEvents = [
  {
    title: 'Sur-Tarang (Singing Competition)',
    date: 'Nov 26, 2025',
    time: '4:00 PM - 6:00 PM',
    description: 'A platform for budding singers to showcase their vocal talent across different genres—classical, pop, and fusion.'
  },
  {
    title: 'Kavya Sandhya (Poetry Evening)',
    date: 'Dec 04, 2025',
    time: '5:00 PM - 7:00 PM',
    description: 'An open-mic event where poets share original or favorite verses. A soothing literary atmosphere for all to enjoy.'
  },
  {
    title: 'Rhythm & Rhyme Fusion Night',
    date: 'Dec 11, 2025',
    time: '6:00 PM onwards',
    description: 'A unique event blending live music and spoken word poetry. Performers collaborate to create soulful performances.'
  }
];
