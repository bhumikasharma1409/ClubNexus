...
const upcomingEvents = [
  {
    ...
    description: 'Show off your best moves in our annual 1v1 hip-hop and freestyle dance battle. Winner takes home the trophy!'
  },
  {
    title: 'Contemporary Workshop',
    date: 'Dec 06, 2025',
    time: '2:00 PM - 4:00 PM',
    description: 'Learn the fundamentals of contemporary dance, focusing on expression and flow. Open to all skill levels.'
  },
  {
    title: 'Annual Dance Showcase Auditions',
    date: 'Dec 10, 2025',
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <div className="bg-black bg-opacity-40 p-8 rounded-2xl shadow-xl backdrop-blur-lg border border-white border-opacity-20 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
            <img 
              src="/custody.jpeg" // From seed.js
              alt="Custody Club" 
              className="w-48 h-48 rounded-full object-cover border-4 border-purple-500 shadow-lg"
            />
            <div className="text-center md:text-left mt-4">
              <h1 className="text-6xl font-extrabold text-purple-500 mb-3">
                Custody
              </h1>
              <p className="text-2xl text-gray-200 mb-4">
                The Dance Club: Where Passion Meets Rhythm
              </p>
              <div className="flex justify-center md:justify-start space-x-4">
                <a 
                  href="https://www.instagram.com/c2s2_custody?igsh=aWNsMnJ5aDN4cXhh" 
                  target="_blank" 
          ...
          <div className="mt-12 border-t border-gray-600 pt-8">
            <h2 className="text-3xl font-bold mb-4 text-purple-400">About Us</h2>
            <p className="text-lg text-gray-300 leading-relaxed">
              The dance club, where passion meets rhythm and creativity takes the stage. We explore various dance forms from hip-hop to contemporary.
            </p>
          </div>
        </div>
      </main>
